...
WafAlert 저장소. Elasticsearch 색인은 제거하고, OTel(OTLP)로 otel-collector에 실시간
...
from app.models.schemas import WafAlert
from app.otel.logger import emit_waf_alert


def add_log(log: WafAlert) -> None:
